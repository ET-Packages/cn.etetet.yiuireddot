...
namespace YIUIFramework.Editor
{
    ...
    internal class UIRedDotKeyView : BaseCreateModule
    {
        ...
        private List<int> GetERedDotKeyTypeList()
        {
        ...
        private void DeleteKeyBtn()
        {
            ...
            var linkData =
                    UIRedDotKeyEditorHelper.GetCheckKeyLink(m_UIRedDotModule.m_RedDotConfigAsset, m_DeleteId);
        ...
        private void ChangeKeyBtn()
        {
            ...
            var linkData =
                    UIRedDotKeyEditorHelper.GetCheckKeyLink(m_UIRedDotModule.m_RedDotConfigAsset, m_GetKeyData.Id);
